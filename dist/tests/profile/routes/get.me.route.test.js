...
const user_get_1 = __importDefault(require("../../../routes/user/user.get"));
...
app.use("/users", user_get_1.default);
const mockProfile = {
    id: "user-id-123",
    pseudo: "TestUser",
...
(0, globals_1.describe)("GET /users/me/profile", () => {
    (0, globals_1.describe)("succès", () => {
        (0, globals_1.it)("devrait retourner 200 avec le profil utilisateur", async () => {
            globals_1.jest.mocked(profileService.fetchUserById).mockResolvedValue({
                ok: true,
                value: mockProfile,
            });
            const res = await (0, supertest_1.default)(app).get("/users/me/profile");
            (0, globals_1.expect)(res.status).toBe(200);
            (0, globals_1.expect)(res.body.pseudo).toBe("TestUser");
            (0, globals_1.expect)(res.body.email).toBe("test@example.com");
        });
        (0, globals_1.it)("devrait retourner les données complètes du profil", async () => {
            globals_1.jest.mocked(profileService.fetchUserById).mockResolvedValue({
                ok: true,
                value: mockProfile,
            });
            const res = await (0, supertest_1.default)(app).get("/users/me/profile");
            (0, globals_1.expect)(res.body.myCollection).toBeDefined();
            (0, globals_1.expect)(res.body.boosters).toBeDefined();
            (0, globals_1.expect)(res.body.decks).toBeDefined();
        });
    });
...
//# sourceMappingURL=get.me.route.test.js.map