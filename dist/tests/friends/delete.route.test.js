...
const user_delete_1 = __importDefault(require("../../routes/user/user.delete"));
const friendsService = __importStar(require("../../services/friends"));
globals_1.jest.mock("@services/friends");
...
app.use("/users", user_delete_1.default);
...
(0, globals_1.describe)("DELETE /users/me/friends/:pseudo", () => {
    (0, globals_1.describe)("succès", () => {
        (0, globals_1.it)("devrait retourner 200 avec success true", async () => {
            globals_1.jest.mocked(friendsService.removeUserFriendByPseudo).mockResolvedValue({
                ok: true,
                value: true,
            });
            const res = await (0, supertest_1.default)(app).delete("/users/me/friends/TestFriend");
    ...
    (0, globals_1.describe)("erreurs métier", () => {
        (0, globals_1.it)("devrait retourner 404 si l'ami n'est pas trouvé", async () => {
            globals_1.jest.mocked(friendsService.removeUserFriendByPseudo).mockResolvedValue({
                ok: false,
                error: "USER_NOT_FOUND",
            });
            const res = await (0, supertest_1.default)(app).delete("/users/me/friends/UnknownFriend");
...
//# sourceMappingURL=delete.route.test.js.map