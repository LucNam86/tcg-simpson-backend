...
(0, globals_1.describe)("POST /users/me/money/daily", () => {
    (0, globals_1.describe)("succès", () => {
        (0, globals_1.it)("devrait retourner 200 avec le nouveau solde et countdownEnds", async () => {
            globals_1.jest.mocked(profileService.updateDailyMoney).mockResolvedValue({
                ok: true,
                value: { money: 200, countdownEnds: mockCountdownEnds },
            });
            const res = await (0, supertest_1.default)(app).post("/users/me/money/daily");
            (0, globals_1.expect)(res.status).toBe(200);
            (0, globals_1.expect)(res.body.money).toBe(200);
            (0, globals_1.expect)(res.body.countdownEnds).toBe(mockCountdownEnds);
        });
        (0, globals_1.it)("devrait appeler updateDailyMoney avec le bon userId", async () => {
            globals_1.jest.mocked(profileService.updateDailyMoney).mockResolvedValue({
                ok: true,
                value: { money: 200, countdownEnds: mockCountdownEnds },
            });
            await (0, supertest_1.default)(app).post("/users/me/money/daily");
            (0, globals_1.expect)(profileService.updateDailyMoney).toHaveBeenCalledWith("user-id-123");
        });
    });
    ...
    (0, globals_1.describe)("erreurs métier", () => {
        ...
        (0, globals_1.it)("devrait retourner 400 si le cooldown n'est pas terminé", async () => {
            globals_1.jest.mocked(profileService.updateDailyMoney).mockResolvedValue({
                ok: false,
                error: "NOT_READY",
            });
            ...
            (0, globals_1.expect)(res.body.error).toBe("NOT_READY");
        });
...
//# sourceMappingURL=post.money.daily.route.test.js.map